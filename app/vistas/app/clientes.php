...
<!--     <nav class="white">
    ...
    <div class="btn-container">
        ...
        <a class="waves-effect waves-light btn" disabled><i class="material-icons left">find_in_page</i>Filtrar</a>
        <a class="waves-effect waves-light btn" disabled><i class="material-icons left">print</i>Imprimir</a>
    </div>
            ...
            <ul class="pagination">
                ...
                <?php endif;?>
                    ...
                    <?php if($datos['start'] > 1):?>
                        <li class='waves-effect'><a href="<?php echo RUTA_URL?>/clientes/pagina/1">1</a></li>
                    ...
                    <?php if($datos['end'] < $datos['total_paginas']):?>
                        <li class='waves-effect'><i class="material-icons">more_horiz</i></li>
                        <li class='waves-effect'><a href="<?php echo RUTA_URL?>/clientes/pagina/<?php echo $datos['total_paginas']; ?>"><?php echo $datos['total_paginas'];?></a></li>
                    <?php endif;?>
