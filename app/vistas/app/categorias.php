        ...
        <div class="paginacion-container">
            <ul class="pagination">
                ...
                <?php if($datos['start'] > 1):?>
                        <li class='waves-effect'><a href="<?php echo RUTA_URL?>/categorias/pagina/1">1</a></li>
                    ...
                    <?php for($i = $datos['start']; $i <= $datos['end']; $i++):?>
                        ...
                        <?php if($datos['pagina'] == $i):?>
                            <li class='waves-effect active teal lighten-1'><a href="<?php echo RUTA_URL?>/categorias/pagina/<?php echo $i; ?>"><?php echo $i?></a></li>
                        <?php else:?>
                    ...
                    <?php if($datos['end'] < $datos['total_paginas']):?>
                        <li class='waves-effect'><i class="material-icons">more_horiz</i></li>
                        <li class='waves-effect'><a href="<?php echo RUTA_URL?>/categorias/pagina/<?php echo $datos['total_paginas']; ?>"><?php echo $datos['total_paginas'];?></a></li>
                    <?php endif;?>
