...
insert into usuarios (id,id_rol,nombre,apellido,usuario,email,pass,fecha_registro) values (null,1,'-','-','Admin','-','$2y$10$RhS2aK7vN/k3v5iDKHHk3OT6wGXA6YvvojMVgmapNzhCKN4zKSrT6','2019-2-18');
 
#$2y$10$RhS2aK7vN/k3v5iDKHHk3OT6wGXA6YvvojMVgmapNzhCKN4zKSrT6
...
insert into clientes (id,id_usuario,cliente,direccion,email,telefono,fecha_registro) values (null, 1, 'Anonimo','-','-','-','2019-01-31');
